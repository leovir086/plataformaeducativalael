...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'start_sesion'); ?>
		<?php echo $form->textField($model,'start_sesion'); ?>
		<?php echo $form->error($model,'start_sesion'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'end_sesion'); ?>
		<?php echo $form->textField($model,'end_sesion'); ?>
		<?php echo $form->error($model,'end_sesion'); ?>
	</div>
