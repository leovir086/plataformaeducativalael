...
class Ocupation extends CActiveRecord {
    ...
    /**
     * Get the list parents of ocupations
     */
    public static function getListOcupations() {
        return CHtml::listData(Ocupation::model()->findAll('ocu_id_ocupation is not null'), 'id_ocupation', 'name_ocupation');
    }
